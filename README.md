...
2. 下载 [magisk-riru-module-xfingerprint-pay-qq.zip](https://github.com/eritpchy/Fingerprint-pay-magisk-qq/releases) ([百度网盘5ahh](https://pan.baidu.com/s/1NYjx2iOg-rpqbUTErzgg4Q)) 进手机
...
1. 运行./gradlew :riru-module-xfingerprint-pay-qq:zip
2. 编译文件位于./release
