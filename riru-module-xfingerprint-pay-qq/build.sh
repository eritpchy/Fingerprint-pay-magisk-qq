function copy_files {
  ...
  7za e -o$TMP_DIR_MAGISK/system/framework/ $MODULE_NAME/libs/fingerprint-pay-qq-magisk.apk classes.dex
  mv -f $TMP_DIR_MAGISK/system/framework/classes.dex $TMP_DIR_MAGISK/system/framework/libxfingerprint_pay_qq.dex
}